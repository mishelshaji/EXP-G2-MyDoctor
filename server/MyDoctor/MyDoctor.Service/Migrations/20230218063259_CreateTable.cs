        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientsMaster_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorLicenseNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Dob = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PhoneNumber = table.Column<long>(type: "bigint", nullable: true),
                    Gender = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorMaster_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorMaster_Department_DepartmentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "462f2a91-f7b8-4dbd-a17c-4d3d279c566d", "Admin", "ADMIN" },
                    { "2", "462f2a91-f7b8-4dbd-a17c-4d3d279c566d", "Doctor", "DOCTOR" },
                    { "3", "462f2a91-f7b8-4dbd-a17c-4d3d279c566d", "Patient", "PATIENT" }
                });

            migrationBuilder.InsertData(
                table: "Department",
                columns: new[] { "Id", "DepartmentName", "Description", "Status" },
                values: new object[,]
                {
                    { 1, "Dentistry", "About dental science", 1 },
                    { 2, "Paediatrics", "About children health", 1 },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorMaster_DepartmentId",
                table: "DoctorMaster",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientsMaster_ApplicationUserId",
